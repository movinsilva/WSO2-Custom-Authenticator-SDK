...
export type BrandingPreferenceThemeInterface =
  StrictBrandingPreferenceThemeInterface &
...
export interface BrandingPreferenceButtonsInterface {
   ...
   */
  primary: ElementStateInterface<
    Omit<ButtonStyleAttributesInterface, "background">
  >;
  /**
   * Secondary Button Preferences.
   */
  secondary: ElementStateInterface<
    Omit<ButtonStyleAttributesInterface, "background">
  >;
}
 ...
 */
export type BrandingPreferenceLayoutInterface =
  StrictBrandingPreferenceLayoutInterface &
