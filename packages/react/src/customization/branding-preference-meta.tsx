...
import {BrandingPreferenceThemeInterface, PredefinedThemes} from '@asgardeo/js-ui-core';
...
export default class BrandingPreferenceMeta {
  ...
  public static getThemeSkeleton(theme: BrandingPreferenceThemeInterface) {
    ...
    const footerFontColor = !isEmpty(theme[theme.activeTheme].footer?.font?.color)
      ...
      : 'inherit';
    const headingFontColor = !isEmpty(theme[theme.activeTheme].typography?.heading?.font?.color)
    ...
    const inputBaseFontColor = !isEmpty(theme[theme.activeTheme].inputs?.base?.font?.color)
      ...
      : 'inherit';
    const inputBaseLabelFontColor = !isEmpty(theme[theme.activeTheme].inputs?.base?.labels?.font?.color)
    ...
    return `
        ...
        --asg-login-page-font-color: ${
          theme[theme.activeTheme].loginPage?.font?.color || 'var(--asg-colors-text-primary)'
        };
        ...
        --oxygen-palette-action-selected: ${
          theme.activeTheme === PredefinedThemes.DARK ? 'rgba(255, 255, 255, 0.16)' : 'rgba(0, 0, 0, 0.08)'
        };
    }
