...
export default class BrandingPreferenceMeta {
  ...
  public static getThemeSkeleton(theme: BrandingPreferenceThemeInterface) {
    ...
    return `
        ...
        --asg-colors-primary-main: ${
          theme[theme.activeTheme].colors.primary.main
        };
        --asg-colors-secondary-main: ${
          theme[theme.activeTheme].colors.secondary.main
        };
        --asg-colors-background-body-main: ${
          theme[theme.activeTheme].colors.background?.body?.main
        };
        --asg-colors-background-surface-main: ${
          theme[theme.activeTheme].colors.background?.surface?.main
        };
        --asg-colors-background-surface-light: ${
          theme[theme.activeTheme].colors.background?.surface?.light
        };
        --asg-colors-background-surface-dark: ${
          theme[theme.activeTheme].colors.background?.surface?.dark
        };
        --asg-colors-background-surface-inverted: ${
          theme[theme.activeTheme].colors.background?.surface?.inverted
        };
        --asg-colors-outlined-default: ${
          theme[theme.activeTheme].colors.outlined?.default
        };
        --asg-colors-text-primary: ${
          theme[theme.activeTheme].colors.text?.primary
        };
        --asg-colors-text-secondary: ${
          theme[theme.activeTheme].colors.text?.secondary
        };
        --asg-colors-alerts-error-main: ${
          theme[theme.activeTheme].colors.alerts?.error?.main
        };
        --asg-colors-alerts-neutral-main: ${
          theme[theme.activeTheme].colors.alerts?.neutral?.main
        };
        --asg-colors-alerts-info-main: ${
          theme[theme.activeTheme].colors.alerts?.info?.main
        };
        --asg-colors-alerts-warning-main: ${
          theme[theme.activeTheme].colors.alerts?.warning?.main
        };
        --asg-colors-illustrations-primary-main: ${
          theme[theme.activeTheme].colors.illustrations?.primary?.main
        };
        --asg-colors-illustrations-secondary-main: ${
          theme[theme.activeTheme].colors.illustrations?.secondary?.main
        };
        --asg-colors-illustrations-accent1-main: ${
          theme[theme.activeTheme].colors.illustrations?.accent1?.main
        };
        --asg-colors-illustrations-accent2-main: ${
          theme[theme.activeTheme].colors.illustrations?.accent2?.main
        };
        --asg-colors-illustrations-accent3-main: ${
          theme[theme.activeTheme].colors.illustrations?.accent3?.main
        };

        /* Components */
        --asg-footer-text-color: ${footerFontColor};
        --asg-footer-border-color: ${
          theme[theme.activeTheme].footer?.border?.borderColor ||
          "var(--asg-colors-outlined-default)"
        };
        --asg-primary-font-family: ${
          theme[theme.activeTheme].typography.font.fontFamily
        };
        --asg-heading-text-color: ${headingFontColor};
        --asg-primary-button-base-text-color: ${
          theme[theme.activeTheme].buttons.primary.base.font.color
        };
        --asg-primary-button-base-border-radius: ${
          theme[theme.activeTheme].buttons.primary.base.border.borderRadius
        };
        --asg-secondary-button-base-text-color: ${
          theme[theme.activeTheme].buttons.secondary.base.font.color
        };
        --asg-secondary-button-base-border-radius: ${
          theme[theme.activeTheme].buttons.secondary.base.border.borderRadius
        };
        --asg-external-login-button-base-background-color: ${
          theme[theme.activeTheme].buttons.externalConnection.base.background
            .backgroundColor
        };
        --asg-external-login-button-base-text-color: ${
          theme[theme.activeTheme].buttons.externalConnection.base.font.color
        };
        ...
        --asg-login-box-background-color: ${
          theme[theme.activeTheme].loginBox?.background?.backgroundColor ||
          "var(--asg-colors-background-surface-main)"
        };
        --asg-login-box-border-color: ${
          theme[theme.activeTheme].loginBox?.border?.borderColor ||
          "var(--asg-colors-outlined-default)"
        };
        --asg-login-box-border-width: ${
          theme[theme.activeTheme].loginBox.border.borderWidth
        };
        --asg-login-box-border-style: solid;
        --asg-login-box-border-radius: ${
          theme[theme.activeTheme].loginBox.border.borderRadius
        };
        --asg-login-box-text-color: ${loginBoxFontColor};
        --asg-login-page-background-color: ${
          theme[theme.activeTheme].loginPage?.background?.backgroundColor ||
          "var(--asg-colors-background-body-main)"
        };
        --asg-login-page-font-color: ${
          theme[theme.activeTheme].loginPage?.font?.color ||
          "var(--asg-colors-text-primary)"
        };
        --asg-input-field-base-text-color: ${
          inputBaseFontColor || "var(--asg-colors-text-primary)"
        };
        --asg-input-field-base-background-color: ${
          theme[theme.activeTheme].inputs.base.background.backgroundColor
        };
        --asg-input-field-base-label-text-color: ${inputBaseLabelFontColor};
        --asg-input-field-base-border-color: ${
          theme[theme.activeTheme].inputs.base.border.borderColor ||
          "var(--asg-colors-outlined-default)"
        };
        --asg-input-field-base-border-radius: ${
          theme[theme.activeTheme].inputs.base.border.borderRadius
        };
        ...
        --oxygen-palette-customComponents-AppShell-Main-background: ${
          theme[theme.activeTheme].colors.background?.body?.main
        };
        --oxygen-palette-customComponents-AppShell-MainWrapper-background: ${
          theme[theme.activeTheme].colors.background?.surface?.dark
        };
        --oxygen-palette-background-paper: ${
          theme[theme.activeTheme].colors.background?.surface?.main
        };
        --oxygen-palette-AppBar-defaultBg: ${
          theme[theme.activeTheme].colors.background?.surface?.dark
        };
        --oxygen-palette-customComponents-Navbar-background: ${
          theme[theme.activeTheme].colors.background?.surface?.dark
        };
        --oxygen-palette-primary-main: ${
          theme[theme.activeTheme].colors.primary.main
        };
        --oxygen-palette-primary-light: ${
          theme[theme.activeTheme].colors.primary.light
        };
        --oxygen-palette-primary-dark: ${
          theme[theme.activeTheme].colors.primary.dark
        };
        --oxygen-palette-action-selected: ${
    ...
    .ui.input , .ui label, .css-15hx6kn-MuiTypography-root{
        font-family: var(--asg-primary-font-family);
    }
    ...
    .login-portal.layout .oxygen-sign-in-box .social-login .ui.button {
    ...
    .login-portal.layout .oxygen-sign-in-box .social-login .ui.button:hover,
    .login-portal.layout .oxygen-sign-in-box .social-login .ui.button:focus,
    .login-portal.layout .oxygen-sign-in-box .social-login .ui.button:active {
        background: var(--asg-external-login-button-base-background-color);
        filter: brightness(0.85);
    }
    ...
    .ui.selection.dropdown:hover, .ui.form .input>div {
    ...
    .login-portal.layout .oxygen-sign-in-box {
    ...
    .login-portal.layout .oxygen-sign-in-box .ui.checkbox label,
    .login-portal.layout .oxygen-sign-in-box .ui.checkbox+label {
        color: var(--asg-input-field-base-label-text-color);
    }
    ...
    .login-portal.layout .oxygen-sign-in-box .ui.list .list > .item .header, .ui.list > .item .header {
        color: var(--asg-login-box-text-color);
    }

    .login-portal.layout .oxygen-sign-in-box .login-portal-app-consent-request {
        color: var(--asg-login-box-text-color);
    }
